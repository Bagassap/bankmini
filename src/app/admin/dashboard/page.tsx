...
import { AdminQuickActionsCard } from "@/components/dashboard/AdminQuickActionsCard";
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 flex items-center gap-1.5 text-sm text-text-secondary">
                ...
                {fullDate} &middot; Ringkasan operasional sistem
              </p>
            </div>
          </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4 md:space-y-6 2xl:space-y-7.5">
          <BalanceCard
            ...
            recent={recent}
            onTransaksiBaru={() => router.push("/admin/transaksi")}
            onLihatMutasi={() => router.push("/admin/mutasi")}
            onRefresh={() => loadStats(true)}
            refreshing={refreshing}
            primaryActionLabel="Pantau Transaksi"
            nasabahHref="/admin/nasabah"
          />
          ...
          <motion.div
            ...
            className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5"
          >
            <GradientStatCard
              tone="orange"
              label="Kas Utama"
          ...
          <div className="grid grid-cols-1 gap-4 md:gap-6 2xl:gap-7.5 lg:grid-cols-3">
            <TransactionList data={recent} className="lg:col-span-2" mutasiHref="/admin/mutasi" />
